...
export const gallery = assertCircuits({
    ...
    ALU: {
        ...
        "out": [
            ...
            { "type": "nibble", "pos": [420, 150], "id": [40, 41, 42, 43], "name": "Y (non signé)" },
            { "type": "nibble", "pos": [210, 60], "orient": "n", "id": [44, 45, 46, 47], "name": "A (signé)", "radix": -10 },
            { "type": "nibble", "pos": [210, 350], "orient": "s", "id": [48, 49, 50, 51], "name": "B (signé)", "radix": -10 },
        ],
        "components": [
    ...
    LatchedAdder: {
        ...
        "wires": [
            ...
            [60, 8, { "waypoints": [[230, 320, "n"], [230, 110, "n"]] }],
            [40, 57],
            [45, 55, { "waypoints": [[280, 520]] }],
            [14, 54, { "waypoints": [[260, 420, "s"], [260, 480]] }],
            [58, 61],
        ],
    },
    ...
    ParityGenerator: {
        ...
        "wires": [
            ...
            [19, 5],
            [13, 7],
            [3, 18, { "waypoints": [[280, 420], [280, 130]] }],
            [3, 12, { "waypoints": [[420, 420]] }],
            [2, 15, { "waypoints": [[340, 360]] }],
            [1, 14, { "waypoints": [[310, 300], [310, 220]] }],
            [2, 21, { "waypoints": [[220, 360]] }],
            [0, 20, { "waypoints": [[190, 180], [190, 100]] }],
            [3, 24, { "waypoints": [[150, 420], [150, 70]] }],
            [1, 27, { "waypoints": [[120, 300], [120, 50]] }],
            [0, 26, { "waypoints": [[100, 30]] }],
        ],
    },
    ...
    ShiftRegister: {
        ...
        "wires": [
            ...
            [12, 14],
            [18, 20],
            [38, 5, { "waypoints": [[230, 260]] }],
            [38, 11, { "waypoints": [[340, 260]] }],
            [38, 17, { "waypoints": [[450, 260]] }],
            [38, 23, { "waypoints": [[560, 260]] }],
            [1, 21, { "waypoints": [[490, 210]] }],
            [1, 15, { "waypoints": [[380, 210]] }],
            [1, 9, { "waypoints": [[270, 210]] }],
            [1, 3, { "waypoints": [[160, 210]] }],
            [0, 2],
            [24, 39],
            [18, 40, { "waypoints": [[530, 50]] }],
            [12, 41, { "waypoints": [[410, 70]] }],
            [6, 42, { "waypoints": [[300, 90]] }],
        ],
    },
