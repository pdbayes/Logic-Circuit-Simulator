...
const Strings_fr = {
    ComponentBar: {
        ...
        Components: RichStringEnum.withProps<ComponentStrings>()({
            InputBit: "Entrée",
            OutputBit: "Sortie",
            OutputNibble: "Affichage de 4 bits",
            Output7Seg: "Afficheur à 7 segments",
            Output16Seg: "Afficheur à 16 segments",
            OutputAscii: "Affichage d’un caractère ASCII",
            OutputBar: "Affichage d’un bit sous forme de segment lumineux",
            Clock: "Horloge",
            InputNibble: "Entrée semioctet",
            InputRandom: "Entrée aléatoire",
            OutputShiftBuffer: "Affichage avec buffer à décalage",
...
const Strings_en: Strings = {
    ComponentBar: {
        ...
        Components: RichStringEnum.withProps<ComponentStrings>()({
            InputBit: "Input",
            OutputBit: "Output",
            OutputNibble: "Nibble Display",
            Output7Seg: "7-Segment Display",
            Output16Seg: "16-Segment Display",
            OutputAscii: "ASCII Display",
            OutputBar: "Bit Display as a Light Bar",
            Clock: "Clock",
            InputNibble: "Nibble Input",
            InputRandom: "Random Input",
            OutputShiftBuffer: "Display with Shift Buffer",
            LabelString: "Label",
            LabelRectangle: "Rectangle",
