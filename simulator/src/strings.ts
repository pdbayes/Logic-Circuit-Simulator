...
const Strings_fr = {
    ...
    Components: {
        ...
        ALU: {
            "A+B": tuple("+", "Addition"),
            "A-B": tuple("–", "Soustraction (A - B)"),
            "B-A": tuple("B–A", "Soustraction (B - A)"),
            "A+1": tuple("A+1", "A + 1"),
            "A-1": tuple("A–1", "A – 1"),
            "-A": tuple("–A", "Négation d’A"),
            "A*2": tuple("A+A", "Addition d’A à lui-même (A × 2)"),
            "A/2": tuple("A/2", "Décalage arithmétique à droite de 1 (A / 2)"),
            "A|B": tuple("OU", "Disjonction (A OU B)"),
            "A&B": tuple("ANETD", "Conjonction (A ET B)"),
            "A|~B": tuple("OUn", "A OU NON(B)"),
            "A&~B": tuple("ETn", "A ET NON(B)"),
