...
import { COLOR_BACKGROUND, COLOR_COMPONENT_BORDER, COLOR_MOUSE_OVER, GRID_STEP, drawWireLineToComponent, COLOR_COMPONENT_INNER_LABELS, strokeSingleLine, colorForBoolean, drawRoundValue } from "../drawutils"
...
export class FlipflopD extends ComponentBase<4, 2, FlipflopDRepr, [TriState, TriState]> {
    ...
    public constructor(savedData: FlipflopDRepr | null) {
        super([false, true], savedData, {
            inOffsets: [[-4, -2, "w"], [-4, 2, "w"], [0, -5, "n"], [0, +5, "s"]],
    ...
    doDraw(g: CanvasRenderingContext2D, ctx: DrawContext) {
        ...
        drawWireLineToComponent(g, this.outputs[OUTPUT.Q], right + 2, this.inputs[OUTPUT.Q].posYInParentTransform, false)
        drawWireLineToComponent(g, this.outputs[OUTPUT.Qb], right + 2, this.inputs[OUTPUT.Qb].posYInParentTransform, false)
