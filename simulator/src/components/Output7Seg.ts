import { FixedArrayFill, FixedReadonlyArray, isNotNull, LogicValue as LogicValue, typeOrUndefined } from "../utils"
import { COLOR_BACKGROUND, COLOR_COMPONENT_BORDER, COLOR_COMPONENT_INNER_LABELS, COLOR_LED_ON, COLOR_MOUSE_OVER, COLOR_OFF_BACKGROUND, drawLabel, drawWireLineToComponent, GRID_STEP } from "../drawutils"
...
export class Output7Seg extends ComponentBase<8, 0, Output7SegRepr, FixedReadonlyArray<LogicValue, 8>> {
    ...
    protected doRecalcValue(): FixedReadonlyArray<LogicValue, 8> {
        return this.inputValues<8>([INPUT.a, INPUT.b, INPUT.c, INPUT.d, INPUT.e, INPUT.f, INPUT.g, INPUT.h])
    }
    ...
    doDraw(g: CanvasRenderingContext2D, ctx: DrawContext) {
        ...
        const [a, b, c, d, e, f, gg, h] = this.value
